...
namespace CleanApiTemplate.Tests.Application.Services;
...
public sealed class ItemServiceTests
{
    ...
    {
        var first = new Item(Guid.NewGuid(), "First", DateTime.UtcNow.AddDays(-1));
        var second = new Item(Guid.NewGuid(), "Second", DateTime.UtcNow);
    ...
    public async Task GetAllAsync_ReturnsAllItems()
    {
        ...
        {
            new(Guid.NewGuid(), "First", DateTime.UtcNow.AddDays(-1)),
            new(Guid.NewGuid(), "Second", DateTime.UtcNow)
        };
